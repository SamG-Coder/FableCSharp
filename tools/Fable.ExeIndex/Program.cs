...
static void RunTraceNewGame(PeImage pe, DumpStore store)
{
    ...
    var links = new List<IndexLink>
    {
        ...
        WriteFnPart(pe, store, family, "Point light pack 00B44F20", 0x00B44F20, 50),
        ...
        WriteFnPart(pe, store, family, "LayoutLights ctor", 0x00BDB400, 80),
        WriteFnPart(pe, store, family, "Light apply 00F39D40", 0x00F39D40, 30),
        WriteFnPart(pe, store, family, "Lighting mgr ctor defaults", 0x00B483A0, 80),
