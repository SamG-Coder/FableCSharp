...
static void RunTraceScriptRuntime(PeImage pe, DumpStore store)
{
    ...
    var links = new List<IndexLink>
    {
        ...
        WriteWalkPart(pe, store, family, "PlayAVI pin Connect 00CA7620", 0x00CA7620, 40),
        ...
        WriteWalkPart(pe, store, family, "PlayAVI ConnectedTo 00CA68F0", 0x00CA68F0, 20),
        ...
        WriteWalkPart(pe, store, family, "PlayAVI QueryDirection 00CA76F0", 0x00CA76F0, 16),
