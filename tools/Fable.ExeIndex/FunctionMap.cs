...
internal static class FunctionMap
{
    ...
    [
        ...
        (0x004D86F0, 0x004D8714, "CHeroCentreDef-factory"),
        (0x004E2333, 0x004E2349, "CQuestCardDef-factory"),
        (0x004E00BC, 0x004E00E9, "CQuestCardDef-ctor"),
        (0x004E3DC3, 0x004E3DD9, "CFlammableDef-factory"),
        (0x004E284B, 0x004E2865, "CFlammableDef-ctor"),
        (0x004D8736, 0x004D875A, "CBoastingPodiumDef-factory"),
        ...
        (0x00A3B500, 0x00A3B900, "PlayAVI-renderer"),
    ...
    [
        ...
        ("PlayAVI copy sample", 0x00A3B730),
        ("PlayAVI ScheduleSample", 0x00CA4AA0),
        ("PlayAVI GetSampleTimes", 0x00CA49F0),
        ("PlayAVI AdviseTime site", 0x00CA4B07),
        ("PlayAVI ShouldDrawSampleNow", 0x00CA5850),
        ("PlayAVI ExecuteRender", 0x00CA4B20),
        ("PlayAVI SetEvent", 0x00A3B8EB),
        ("PlayAVI WaitEx leave", 0x00628AAC),
        ("PlayAVI CBaseRenderer ctor", 0x00CA7360),
        ("PlayAVI renderer QI", 0x00CA6080),
        ("PlayAVI leftover QI", 0x00CA4780),
        ("PlayAVI CBaseFilter QI", 0x00CA7500),
        ("PlayAVI pin QI", 0x00A3BD00),
        ("PlayAVI IMemInputPin Receive", 0x00CA6050),
        ("PlayAVI pin Receive", 0x00CA7210),
        ("PlayAVI filter Receive", 0x00CA6C40),
        ("PlayAVI pin GetAllocator", 0x00CA89F0),
        ("PlayAVI pin NotifyAllocator", 0x00CA8AC0),
        ("PlayAVI pin GetAllocatorReq", 0x00CA8EC0),
        ("PlayAVI WaitForRenderTime", 0x00CA65B0),
        ("PlayAVI Ready", 0x00A3BCE0),
        ("PlayAVI thread signal", 0x00CA6580),
        ("PlayAVI ClearPending", 0x00CA4BF0),
        ("PlayAVI StartStreaming", 0x00CA4D80),
        ("PlayAVI StopStreaming", 0x00CA4E30),
        ("PlayAVI volume", 0x00A3B920),
        ("PlayAVI wait-state", 0x00A3B0F0),
        ("PlayAVI release graph", 0x00A3B380),
        ("PlayAVI player dtor", 0x00A3BC20),
        ("PlayAVI open-fail", 0x00628DEB),
        ("PlayAVI MemoryAllocator CLSID", 0x012AAC24),
        ("PlayAVI IMemAllocator IID", 0x012A9A54),
        ("PlayAVI GetPin", 0x00CA6A30),
        ("PlayAVI pin ctor", 0x00CA4F40),
        ("PlayAVI CBasePin QI", 0x00CA7CE0),
        ("PlayAVI IPin QueryAccept", 0x00CA84C0),
        ("PlayAVI accept type", 0x00A3B590),
        ("PlayAVI GetMediaType", 0x00CA84F0),
        ("PlayAVI ReceiveConnection", 0x00CA66D0),
        ("PlayAVI FindPin", 0x00CA4910),
        ("PlayAVI GetPinCount", 0x00CA53A0),
        ("PlayAVI GetPin virtual", 0x00CA53B0),
        ("PlayAVI CreateTexture", 0x009FA280),
        ("PlayAVI present texture", 0x009FA4E0),
        ("PlayAVI CBaseFilter ctor", 0x00CA61D0),
        ("PlayAVI LockRect", 0x009FA450),
        ("PlayAVI event pump", 0x00A3B000),
        ("PlayAVI blit", 0x009DC870),
        ("PlayAVI BeginScene", 0x009BEF20),
        ("PlayAVI EndScene", 0x009BEF50),
        ("PlayAVI Present", 0x009BEEB0),
