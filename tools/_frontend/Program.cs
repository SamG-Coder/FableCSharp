...
static void Dump520(GameBin bin, NamesBin names)
{
    ...
    var widgets = new[]
    {
        ...
        "UI_OPTIONS_EDITBOX_BUTTON_TABLES",
        "UI_BUTTON_OPTIONS_LEFT",
        "UI_BUTTON_OPTIONS_RIGHT_EDITBOX",
        "UI_NEW_PROFILE_TEXT",
        "UI_NEW_PROFILE_EDIT_BOX",
        ...
        "UI_OPTIONS_TEXT_CONTROL_WASD",
        "UI_OPTIONS_TEXT_SLIDER_WHOLE_CAMERA_UP_DOWN",
        "UI_OPTIONS_CAMERA_UP_DOWN_TEXT_SLIDER",
        "UI_TEXT_NORMAL",
        "UI_TEXT_INVERTED",
        "UI_OPTIONS_SLIDER_WHOLE_CAMERA_SENSITIVITY",
        "UI_SLIDER_PARENT_CAMERA_SENSITIVITY",
        "UI_SLIDER_CAMERA_SENSITIVITY",
        "UI_ACCEPT_NEW_PROFILE",
        "UI_CANCEL",
        "UI_HELPER_BUTTON_MOUSE_AREA",
        "UI_SPRITE_ACCEPT_ON",
        "UI_SPRITE_ACCEPT_OFF",
        "UI_SPRITE_BACK_ON",
        "UI_SPRITE_BACK_OFF",
        "UI_MOUSE_POINTER",
    };
