...
public sealed class FrontendUiDefTests
{
    ...
    public void Factory_builds_press_start_then_main_menu_from_the_same_walk()
    {
        ...
        Assert.Equal(0x01, FrontendWidgetType.StyleFlagsPosition);
        Assert.Equal(0x02, FrontendWidgetType.StyleFlagsColour);
        Assert.Equal(0x04, FrontendWidgetType.StyleFlagsScale);
        ...
        Assert.Equal(8, menu[0].StylePositionX?.Count);
        Assert.Equal(8, menu[0].StylePositionY?.Count);
        Assert.Equal(8, menu[0].StyleZoomX?.Count);
        Assert.Equal(8, menu[0].StyleZoomY?.Count);
        Assert.Equal(8, menu[0].StyleFlags?.Count);
        Assert.Equal(8, menu[0].StyleChangeTypes?.Count);
        Assert.Equal(8, menu[0].StyleLinearChanges?.Count);
