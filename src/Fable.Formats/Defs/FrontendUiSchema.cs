...
public static class FrontendUiSchema
{
    ...
    public static bool TryConsume(GameBinEntry entry, out int end, out string? error)
    {
        ...
        reader.F32(0xC1C40F15, "InputDelay");
        ...
        reader.U8(0x80E7CC0F, "EditBoxParentIsButton");
        reader.U8(0x85F48C10, "PasswordBox");
        reader.I32(0xC906BCC4, "EditBoxCharLimit");
        reader.U8(0x7E593159, "EditBoxUsesIME");
        reader.Utf16(0x2DA92517, "MovieFilename");
        reader.U8(0xB5AF7F34, "DisallowSpaceAsFirstChar");
        ...
        reader.I32(0x180E20C5, "HoveredState");
        reader.I32(0xC08267F2, "LeftClickedState");
        reader.I32(0x50D249C6, "RightClickedState");
