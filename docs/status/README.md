...
| `user.ini` `009EB430`: `SetMaxAnisotropy` unknown; `RunScript("joystick.ini")` `009ECB70`/`00999230` miss; `ActivateQuest` `00419CE0` `[world+56]` UNREAD | PROVEN | `UserIni_009EC890_RunScript_joystick_is_00999230_miss` |
