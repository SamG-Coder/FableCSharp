...
| Type-1 `00CB8220` Main `00A44880` → `00CE7670` state 0 yields on `Q_NewOakValeIntro`. Does not activate that quest. `004167DA` not called | PROVEN | `Type1_00CB8220_Gameflow_state0_yields_on_Q_NewOakValeIntro` |
