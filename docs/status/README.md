...
runtime HEAD `012dccad` (*Runtime: 00416E78 pumps 00446A30
player-interface listeners after WorldFrame>1.*).
...
Recent commits (`8bccec3` … `012dccad`) lock the retail pump, not
...
| `00416E78` vtbl+24 after WorldFrame>1 pumps `[game+32].vtbl+4` `00446A30` player-interface listeners | PROVEN | `012dccad` / `Player_interface_00446A30_pumps_listeners_after_WorldFrame`. Init Player Interface `004473A0` alloc `0x898` vtbl `01231BDC` stored at game+32. Then `004457F0` `[+2196]=0`, poll `00446330` / `009F4ED0`. Skip device 2 / key 15 / type 0. Listeners vtbl+32 accept, vtbl+16 apply. Zero E8 of `00446A30` itself; caller is `00416E78`. Not the retail frontend `0042E3EE` walk. Not `00DBDE40`. |
...
| Recovered `00446330` listener vtbl (player-move body) | UNREAD / PARTIAL | `RecordingInputListener` is a stand-in; miss path `00446220` vtbl+24 unread |
