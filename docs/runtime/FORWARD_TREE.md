...
│       ├── later 004AEA70=1  PROVEN 00435F70 / dest empty / 009BEEB0
...
│   │   / CheckBarrowFieldsGuards at tail
│   │   state 0 00CE77D7 then 009D8650
│   │   same 00CB7C40: 00CEF3B0 [+72]=0
│   │   yield; 00CEF550 vtbl+1144
...
├── [0x13B8630]==0 → 0041707E interpolation  PROVEN first-seen
│   ├── world+164==0
│   ├── 004166E2 / 0041919C clamp t
│   ├── 0049E080 → 006B42F0 (+68 already 1)
│   ├── 004AEA70  PROVEN
│   │   +9826=1 → !0041674A(post-update +9836)
│   │   first-seen catchup-hit → 0
...
│       push 1 / [+90552]=1
│       +232 ctor 0x1E, 00434F60 dec
│       first Present +232>0 → 00434CD0  PROVEN
│       ├── +216=0 01375CDC=0 skip dest fade
│       └── 009D8250 ret dest empty  PROVEN
│       009BEF20 BeginScene / 009D8CF0
│       00435000 00449960/00487DD0 00A01B50 miss
│       skip 00639E40  PROVEN
│       00435070 00487DC0 miss skip 0057B43F
│       009D9C80 dirty-list
│       009DA9F0(1) +16020==+16024 empty dest
│       009DB6E6 no DIP  PROVEN
