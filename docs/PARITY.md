...
| Sea / water banks | Exe intern `__ENGINE_SEA_STATIC_MAP_BANK_FILE__` (`0x1436EC4`) / `__ENGINE_WATER_STATIC_MAP_BANK_FILE__` (`0x1436EC8`) / `__STATIC_MAP_COMMON_HEADER__` (`0x1436ECC`). STB stores 25 sea blobs named prefix+region (`StartOakVale` 129966, u32[0]=7363). No water-prefix STB entries. `00B6D4D0` only stores the sea name on `CEngineWaterRenderer`; `00B41FA0` actually reads the water member. | `LevFormatTests`, exe `00B4282B` / `00B41FA0` |
